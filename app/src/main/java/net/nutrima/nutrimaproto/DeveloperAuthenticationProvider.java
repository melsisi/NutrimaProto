...
import net.nutrima.devauth.client.AmazonCognitoSampleDeveloperAuthenticationClient;
import net.nutrima.devauth.client.GetTokenResponse;
import net.nutrima.devauth.client.LoginCredentials;
